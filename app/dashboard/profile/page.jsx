...
import { Camera, Mail, Phone, User, Calendar, MapPin, Heart, Shield, FileText } from "lucide-react"
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-2xl font-bold sm:text-3xl">{profile.displayName || "Your Profile"}</h1>
      ...
      {isEditing ? (
        ...
        <div className="grid gap-8 grid-cols-1">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="space-y-6">
                <div className="flex items-start">
                  <User className="h-5 w-5 text-amber-500 mt-1 mr-4 flex-shrink-0" />
                  <div>
                    <p className="text-sm font-medium text-gray-500 mb-1">Full Name</p>
                    <p className="text-gray-800 text-lg">{profile.displayName || "Not provided"}</p>
                  </div>
                </div>

                <div className="flex items-start">
                  <Calendar className="h-5 w-5 text-amber-500 mt-1 mr-4 flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 text-lg">{profile.gender || "Not provided"}</p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-800 text-lg">{profile.emergencyContact || "Not provided"}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                <Phone className="h-5 w-5 text-amber-500 mt-1 mr-4 flex-shrink-0" />
                <div>
                  <p className="text-sm font-medium text-gray-500 mb-1">Emergency Phone</p>
                  <p className="text-gray-800 text-lg">{profile.emergencyPhone || "Not provided"}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-8 shadow-sm">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="flex items-start">
                <Heart className="h-5 w-5 text-amber-500 mt-1 mr-4 flex-shrink-0" />
                <div>
                  <p className="text-sm font-medium text-gray-500 mb-1">Blood Type</p>
                  <p className="text-gray-800 text-lg">{profile.bloodType || "Not provided"}</p>
                </div>
              </div>

              <div className="flex items-start">
                <Shield className="h-5 w-5 text-amber-500 mt-1 mr-4 flex-shrink-0" />
                <div>
                  <p className="text-sm font-medium text-gray-500 mb-1">Allergies</p>
                  <p className="text-gray-800 text-lg">{profile.allergies || "None"}</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-800 text-lg">{profile.medicalConditions || "None"}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-800 text-lg">{profile.currentMedications || "None"}</p>
                </div>
              </div>
            </div>
          </div>
