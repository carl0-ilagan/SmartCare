              ...
              {!loading && patient ? (
                <>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-white/80">Patient Profile</p>
                  </div>
                </>
              ) : (
                <>
          ...
          {activeTab === "profile" ? (
            <>
              ...
              <div className="grid gap-6 md:grid-cols-3">
                {/* Contact Information */}
                <div className="rounded-lg border border-pale-stone bg-white p-5 shadow-sm transition-all hover:shadow-md hover:border-amber-300">
                  <h2 className="mb-4 text-lg font-semibold text-graphite">Contact Information</h2>
                  <div className="space-y-4">
                    <div className="flex items-start">
                      <User className="mr-3 mt-0.5 h-5 w-5 text-amber-500" />
                      <div>
                    ...
                    <div className="flex items-start">
                      <Mail className="mr-3 mt-0.5 h-5 w-5 text-amber-500" />
                      <div>
                    ...
                    <div className="flex items-start">
                      <Phone className="mr-3 mt-0.5 h-5 w-5 text-amber-500" />
                      <div>
                    ...
                    {patient.address && (
                      <div className="flex items-start">
                        <MapPin className="mr-3 mt-0.5 h-5 w-5 text-amber-500" />
                        <div>
                ...
                <div className="rounded-lg border border-pale-stone bg-white p-5 shadow-sm transition-all hover:shadow-md hover:border-amber-300">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      <Calendar className="mr-3 mt-0.5 h-5 w-5 text-amber-500" />
                      <div>
                    ...
                    <div className="flex items-start">
                      <Activity className="mr-3 mt-0.5 h-5 w-5 text-amber-500" />
                      <div>
                    ...
                    <div className="flex items-start">
                      <Stethoscope className="mr-3 mt-0.5 h-5 w-5 text-amber-500" />
                      <div>
                    ...
                    <div className="flex items-start">
                      <Pill className="mr-3 mt-0.5 h-5 w-5 text-amber-500" />
                      <div>
                ...
                <div className="rounded-lg border border-pale-stone bg-white p-5 shadow-sm transition-all hover:shadow-md hover:border-amber-300">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      <CalendarDays className="mr-3 mt-0.5 h-5 w-5 text-amber-500" />
                      <div>
                    ...
                    <div className="flex items-start">
                      <MessageCircle className="mr-3 mt-0.5 h-5 w-5 text-amber-500" />
                      <div>
                    ...
                    <div className="flex items-start">
                      <FileIcon className="mr-3 mt-0.5 h-5 w-5 text-amber-500" />
                      <div>
                    ...
                    <div className="flex items-start">
                      <Clock className="mr-3 mt-0.5 h-5 w-5 text-amber-500" />
                      <div>
                    ...
                    <div className="flex items-start">
                      <Shield className="mr-3 mt-0.5 h-5 w-5 text-amber-500" />
                      <div>
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <button
                  ...
                  className="group flex items-center justify-between rounded-lg border border-pale-stone bg-white p-4 shadow-sm transition-all hover:shadow-md hover:border-amber-300"
                >
                  <div className="flex items-center">
                    <div className="mr-3 flex h-10 w-10 items-center justify-center rounded-full bg-amber-100 text-amber-600 group-hover:bg-amber-200">
                  ...
                  <ChevronRight className="h-5 w-5 text-drift-gray group-hover:text-amber-500 transition-colors" />
                </button>
